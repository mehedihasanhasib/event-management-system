...
// Attendee Routes
Route::get('/event/{slug}/attendees', [AttendeeController::class, 'index'])->name('attendee.index'); // Attendees list for a specific event
Route::post('/event/{slug}/attendee/store', [AttendeeController::class, 'store'])->name('attendee.store'); // Register new attendee for a specific event

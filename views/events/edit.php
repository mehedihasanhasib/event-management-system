                ...
                <div class="card-body">
                    <form id="event-update-form" action="<?= route('event.update') ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="eventDescription" name="event_description" rows="4" placeholder="Provide a brief description of the event" required><?= $event['description'] ?? '' ?></textarea>
